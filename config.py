...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Dhimxn")
...
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "DHIMANDISCUS")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "DDSRVR")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/TEAM-DHIMAN/MUSIC-VC-RAID")
